...
class IpAddressesController < ApplicationController
  rescue_from ValidateAndExtractAddress::AddressInvalid, with: :render_address_invalid_response
  ...
  def address_param
    @address_param ||= ValidateAndExtractAddress.new.call(params[:address])
  end
end
